...
// $routes->get('/', 'CRUDctrl::index', ['filter' => 'login']);
// $routes->get('/', 'CRUDctrl::index');
// $routes->get('/tambahData', 'CRUDctrl::tambah');
// $routes->post('/tambahdata', 'CRUDctrl::simpan');
// $routes->delete('/hapus/(:num)', 'CRUDctrl::hapus/$1');
